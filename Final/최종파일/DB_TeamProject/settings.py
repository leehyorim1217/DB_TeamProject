...
ROOT_URLCONF = 'DB_TeamProject.urls'
...
WSGI_APPLICATION = 'DB_TeamProject.wsgi.application'
...
# 로그인 후 이동할 페이지
LOGIN_REDIRECT_URL = '/'   # 로그인 성공하면 메인 페이지로
LOGOUT_REDIRECT_URL = '/'  # 로그아웃 성공하면 메인 페이지로
LOGIN_URL = '/login/'